...
from Server.InputFileAnalyser import get_factID
from Server.InputFileAnalyser import get_statements_tokens
from Server.InputFileAnalyser import get_statements_names
import os
import re
import datetime
...
def generate_result(filename, max_corpus_index):
    print("Generating the result.ttl")
...
def generate_training_result(filename, max_corpus_index):
    ...
    for i in range(len(id_list)):
        ...
        file.write(result)
    file.close()
    print("training_result.ttl has been generated")
