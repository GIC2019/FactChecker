...
for j in xrange(len(triplets)):
	...
	print w1.jaccard_distance(w2)
	print w11.jaccard_distance(w22)
	if w1.jaccard_distance(w2)>=0.5 and w11.jaccard_distance(w22)>=0.5 and triplets[j].subject == target.subject:		
		#sprint "aaya"
		flag1=1
		if p.find("not") !=-1:
			flag1=0
